...
|---|---|---|---|
| `plateforme_de_surveillance_des_salles_serveurs.ino` | USB Serial → serial_relay.py | DHT22 D4, MQ135 A0, ACS712 A1, PIR D5, Buzzer D6, LED D9/10/11 | **Fichier opérationnel du projet** |
| `surveillance_salle_serveurs.ino` | USB Serial → serial_relay.py | DHT22 D4, MQ135 A0, ACS712 A1, PIR D5, Buzzer D6, LED D9/10/11 | Version avancée (buzzer non-bloquant) |
...
**Seuils :** T ≥ 28/32 °C — H ≥ 75/85 % — G ≥ 400/600 ppm — I ≥ 10/15 A — P ≥ 1000/1500 W
